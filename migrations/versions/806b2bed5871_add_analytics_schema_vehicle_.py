...
def upgrade():
    ...
    # NOTE: Vehicle and ServiceCategory tables already exist in the database
    # (created via db.create_all() or manually), so we skip creating them here.
    ...
    with op.batch_alter_table('inventory', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('reorder_point', sa.Integer(), nullable=False, server_default='5'))
        batch_op.add_column(sa.Column('created_at', sa.DateTime(), nullable=False, server_default=sa.func.now()))
    ...
    with op.batch_alter_table('service_tickets', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('labor_rate', sa.Float(), nullable=False, server_default='75.0'))
...
def downgrade():
    ...
    # NOTE: Vehicle and ServiceCategory tables were NOT created by this migration,
    # so we don't drop them here.
